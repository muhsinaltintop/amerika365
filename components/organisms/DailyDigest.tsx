...
export function DailyDigest() {
  return (
    <section className="flex justify-center border-b border-[#4fc5db]/20 bg-[#4fc5db]/10 py-3 dark:bg-[#0756b0]/5">
      <div className="flex w-full max-w-[1200px] flex-col items-center gap-4 px-6 md:flex-row">
        <h2 className="flex items-center gap-2 whitespace-nowrap text-sm font-bold text-[#1b1a6b] dark:text-[#4fc5db]">
